...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        Rectangle rectangle = new Rectangle(2.89,3.0);
        Circle circle = new Circle(4.0,3.0);
    ...
    private static void exercise3() {
        ...
        Piano piano = new Piano("Stephynx","Bechstein");
        Guitar guitar = new Guitar("Blackie","Fender Stratocaster");
        piano.play();
        guitar.play();
